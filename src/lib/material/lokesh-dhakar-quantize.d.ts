// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/quantize/index.d.ts
declare module '@lokesh.dhakar/quantize' {
    ...
    export default function quantize(pixels: quantize.RgbPixel[], colorCount: number): quantize.ColorMap | false;
}